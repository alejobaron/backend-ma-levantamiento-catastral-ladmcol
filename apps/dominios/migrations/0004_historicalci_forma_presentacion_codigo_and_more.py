...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dominios', '0003_remove_historicalclaseviaprincipalclase_history_user_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.CharField(choices=[('Imagen', 'Imagen'), ('Documento', 'Documento'), ('Mapa', 'Mapa'), ('Video', 'Video')], max_length=50, verbose_name='Tipos de formatos de presentación de la fuente')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical Clase de geometría',
                'verbose_name_plural': 'historical Clases de geometrias',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateField(blank=True, editable=False, verbose_name='Fecha de Modificación')),
                ('deleted_date', models.DateField(blank=True, editable=False, verbose_name='Fecha de Elimnación')),
                ('tipo', models.CharField(choices=[('Documento_Privado', 'Documento privado'), ('Escritura_Publica', 'Escritura pública (Documento público)'), ('Sentencia_Judicial', 'Sentencia judicial (Documento público)'), ('Acto_Administrativo', 'Acto administrativo (Documento público)'), ('Sin_Documento', 'Sin documento')], max_length=100, verbose_name='Tipos de documentos.')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
